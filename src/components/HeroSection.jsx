...
function HeroSection({ contact }) {
  ...
  return (
    <motion.div
      ...
      className="max-w-[800px] mx-auto pt-75 lg:pt-25 md:ml-40 font-[Poppins]"
    >
      <div className="flex text-center items-center gap-4 justify-center">
        <div className="md:p-8 w-full">
          ...
          >
            ...
            <motion.span
             whileHover={{ scale: 1.2, fill:'rgb(255,153,0)' }} transition={{type: "spring", stiffness: 200}} className='text-white w-20 fill-white  text-4xl'><a href="https://leetcode.com/u/Mohit18326/" target='blank'><svg
             className="w-10 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="leetcode">
  ...
  <path  d="M8.115 22.814a2.109 2.109 0 0 1-.474-.361c-1.327-1.333-2.66-2.66-3.984-3.997-1.989-2.008-2.302-4.937-.786-7.32a6 6 0 0 1 .839-1.004L13.333.489c.625-.626 1.498-.652 2.079-.067.56.563.527 1.455-.078 2.066-.769.776-1.539 1.55-2.309 2.325-.041.122-.14.2-.225.287-.863.876-1.75 1.729-2.601 2.618-.111.116-.262.186-.372.305-1.423 1.423-2.863 2.83-4.266 4.272-1.135 1.167-1.097 2.938.068 4.127 1.308 1.336 2.639 2.65 3.961 3.974.067.067.136.132.204.198.468.303.474 1.25.183 1.671-.321.465-.74.75-1.333.728-.199-.006-.363-.086-.529-.179z"></path>
            ...
            <motion.span whileHover={{ scale: 1.2,}} transition={{type: "spring", stiffness: 200}} className='text-white fill-white hover:fill-green-500 w-20 text-4xl'><a href="https://www.geeksforgeeks.org/user/mohitgoswgcs3/" target='blank'><svg className="w-12" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
