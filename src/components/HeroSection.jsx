      ...
      <div className="flex text-center items-center gap-4 justify-center">
        <div className="md:p-8 w-full">
          ...
          >
            ...
            <motion.span
             whileHover={{ scale: 1.2, fill:'rgb(255,153,0)' }} transition={{type: "spring", stiffness: 200}} className='text-white w-20 fill-white  text-4xl'><a href="https://leetcode.com/u/Mohit18326/" target='blank'>
